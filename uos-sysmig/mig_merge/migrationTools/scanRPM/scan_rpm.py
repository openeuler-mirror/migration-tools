...
import mig_merge.migrationTools.utils.html as html
...
class ParsedPkgInfoAdd(object):
    ...
    def fill_provides_item(self):
        ...
        #    repodb_path = PathConf.data_path + "/repo-sqlite/uos-1020a/aarch64/63ab13615c7e35a77bfb0719b6c2af5c4298a609132950963f4a0ea99b341112-primary.sqlite"
        #elif PathConf.arch == "x86_64":
        #    if self.repo_mark == 'uos-1020a':
        #        sqlite_name = "/repo-sqlite/uos-1020a/x86_64/04318476105fb5fcf4a193d862ab18645368238e2aaa1a942ba07323a2a02c59-primary.sqlite"
        #    elif self.repo_mark == 'uos-1021a':
        #        sqlite_name = "/repo-sqlite/uos-1021a/x86_64/04318476105fb5fcf4a193d862ab18645368238e2aaa1a942ba07323a2a02c59-primary.sqlite"
        #    elif self.repo_mark == 'uos-1050a':
        #        sqlite_name = "/repo-sqlite/uos-1050a/x86_64/04318476105fb5fcf4a193d862ab18645368238e2aaa1a942ba07323a2a02c59-primary.sqlite"
        #    elif self.repo_mark == 'uos-1051a':
        #        sqlite_name = "/repo-sqlite/uos-1051a/x86_64/04318476105fb5fcf4a193d862ab18645368238e2aaa1a942ba07323a2a02c59-primary.sqlite"
        #    else:
        #        sqlite_name = "/repo-sqlite/uos-1001c/x86_64/3e94208457ced3da2746d36e31b717717aedb5970281c48e25acf64c36ff49b2-primary.sqlite"
        #    repodb_path = 'mig_merge/data' + sqlite_name 
        #else:
        #    pass

        with DBOperate(self.repodb_path) as db:
            for provide_tuple in provides_tuple_list:
                ...
                for row in db.cursor:  # 实际上，由于 provide 名是唯一的，若有结果也一定是 1 。若为 0 则直接重新开始循环
                    ...
                    if provide_tuple['v'] != None and row[3] != None:
                        ...
                        #20220419 modify by lihp ：数据库表 provides 中 version 相同也在报告中显示
